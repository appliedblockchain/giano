...
const Wallet: React.FC = () => {
  ...
  const tokenProxy = useMemo(() => (walletClient ? walletClient.proxyFor(tokenContract) : undefined), [walletClient]);
  const coinProxy = useMemo(() => (walletClient ? walletClient.proxyFor(coinContract) : undefined), [walletClient]);
