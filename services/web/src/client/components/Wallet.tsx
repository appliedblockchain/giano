...
import type { GenericERC20, GenericERC721 } from '@appliedblockchain/giano-contracts/typechain-types';
import { GenericERC20__factory, GenericERC721__factory } from '@appliedblockchain/giano-contracts/typechain-types';
