...
## Deployer account
`0xaA6113eEf876eEAF6acC863a9f6da05B44550E93`

Since we're using the create2 strategy, the addresses of the deployed contracts will be the same on any chain and deployment order, as long as the generated bytecode remains the same.

At the time of writing, the following contracts are available on Base Sepolia and Base Mainnet:
### Giano Smart Wallet Factory
`0x5A1dd8C52Daaa27D9ced48f7F96b2b05dD6dB0B0`
### Giano Smart Account
`0x77cFc807DbcFa0aa42561fb39B8eEFb62864bb95`