...
export function createMockInjection(
  ...
  return {
    ...
    encodeUserId: (id: string) => new TextEncoder().encode(id.padEnd(41, '0')),
    decodeUserId: () => ({ userId: 'x', walletFactoryAddress: FACTORY_ADDRESS, chainId: TEST_CHAIN_ID, chainType: 0 }),
