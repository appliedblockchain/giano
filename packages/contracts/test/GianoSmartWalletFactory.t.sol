...
contract GianoSmartWalletFactoryTest is Test {
    ...
    function test_constructor_revertsIfImplementationIsNotDeployed(address implementation) public {
        ...
        vm.expectRevert(GianoSmartWalletFactory.ImplementationUndeployed.selector);
        new GianoSmartWalletFactory(implementation);
    }
