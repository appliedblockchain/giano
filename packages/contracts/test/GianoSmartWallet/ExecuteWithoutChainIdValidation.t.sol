...
contract TestExecuteWithoutChainIdValidation is SmartWalletTestBase {
    ...
    function setUp() public override {
        ...
        userOpCalldata = abi.encodeWithSelector(GianoSmartWallet.executeWithoutChainIdValidation.selector);
    }
    ...
    function test_succeeds_whenSelectorAllowed() public {
        ...
        userOpCalldata = abi.encodeWithSelector(GianoSmartWallet.executeWithoutChainIdValidation.selector, calls);
    ...
    function test_reverts_whenSelectorNotApproved() public {
        bytes4 selector = GianoSmartWallet.execute.selector;
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                GianoSmartWallet.SelectorNotAllowed.selector, GianoSmartWallet.execute.selector
            )
        );
        account.executeWithoutChainIdValidation(calls);
    }
    ...
    function test_reverts_whenOneSelectorNotApproved() public {
        bytes4 badSelector = GianoSmartWallet.execute.selector;
